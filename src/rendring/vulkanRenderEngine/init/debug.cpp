...
{
	VkBool32 debug::callback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
							 ...
							 const VkDebugUtilsMessengerCallbackDataEXT *pCallbackData, void *pUserData)
	{
		switch (messageSeverity)
		{
			...
			default:
				LOG_FATAL("something went very wrong messageSeverity = " << messageSeverity << ", msg"
	...
	void debug::setup()
	{
		vk::DebugUtilsMessengerCreateInfoEXT createInfo = vk::DebugUtilsMessengerCreateInfoEXT(
			...
			callback, nullptr);
		LOG_INFO((instance::getLoader().getVkHeaderVersion() == VK_HEADER_VERSION))
		debugMessenger =
			instance::getInstance().createDebugUtilsMessengerEXT(createInfo, nullptr, instance::getLoader());
	}
